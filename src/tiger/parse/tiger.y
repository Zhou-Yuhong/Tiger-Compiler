...
%token
  COMMA COLON SEMICOLON LPAREN RPAREN  RBRACK
  LBRACE RBRACE 
...
actuals: exp {$$ = new absyn::ExpList($1);}
...
fundec: fundec_one %prec LAST{$$ =new absyn::FunDecList($1);}
...
decs_nonempty_s:  vardec {$$ = $1;}
  ...
  ;
decs_nonempty: decs_nonempty_s %prec LAST{$$ = new absyn::DecList($1);}
...
tydec: tydec_one %prec LAST{$$ = new absyn::NameAndTyList($1);}
